...
const scholarshipFactory_ABI = [
    ...
    },
    {
      "inputs": [
        {
          "internalType": "address",
          "name": "_newRoleNFTAddress",
          "type": "address"
        }
      ],
      "name": "updateRoleNFTAddress",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
...
//may not be used but just in case
const scholarshipAutomationHandler_CA =
  '0x14331CcdE4041B1DeFDDC5AE56A1Dbd613Af4772';
const scholarshipAutomationHandler_ABI = [
    {
      "inputs": [
        {
          "internalType": "address",
          "name": "_scholarshipFactoryAddress",
          "type": "address"
        }
      ],
      "stateMutability": "nonpayable",
    ...
    },
    {
      "inputs": [
        {
          "internalType": "address[]",
          "name": "scholarshipAddresses",
          "type": "address[]"
        }
      ],
      "name": "batchTriggerUpkeep",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    ...
    {
      "inputs": [],
      "name": "scholarshipFactoryAddress",
      "outputs": [
        {
          "internalType": "address",
          "name": "",
    ...
    },
    {
      ...
      "name": "updateScholarshipFactoryAddress",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
...
export {
  ...
  scholarship_ABI,
  scholarshipAutomationHandler_CA,
  scholarshipAutomationHandler_ABI,
};
