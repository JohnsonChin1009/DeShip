...
const scholarshipFactory_CA = '0x9C6E7b018C3EE3167e38CEE76B714f8C4982A815'
const scholarshipFactory_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_gpa', type: 'uint256' },
      {
        internalType: 'string',
...
const scholarship_ABI = [
  ...
  },
  {
    ...
    name: 'eligibility',
    outputs: [
      { internalType: 'uint256', name: 'gpa', type: 'uint256' },
      {
        internalType: 'string',
  ...
  },
  {
    ...
    name: 'getMilestone',
    outputs: [
      { internalType: 'string', name: 'titleReturn', type: 'string' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'fundsWithdrawn', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
export { roleNFT_CA, roleNFT_ABI, scholarshipFactory_CA, scholarshipFactory_ABI, scholarship_ABI };